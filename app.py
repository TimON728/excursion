...
excursions = [
    {"id": 1, "title": "Вепсская культура и быт", "type": "Этнография", "capacity": "Семейная", "duration_hours": "3 часа",
    ...
    {"id": 3, "title": "История флота: от Петра до наших дней", "type": "История", "capacity": "Групповая",
     "duration_hours": "2 часа", "price": 3500,
    ...
    {"id": 6, "title": "Индустриальный гигант: Нижне-Свирская ГЭС", "type": "Индустриальный туризм",
     "capacity": "Семейная", "duration_hours": "2 часа",
     ...
     "phone_number": "+7 (911) 647 38 92", "route": "Свирьстрой (ГЭС)",
...
map_locations = [
    {"name": "Лодейное Поле",
     "desc": "Колыбель Балтийского флота. Здесь воздух пропитан запахом сосновой смолы и ветра Свири. В центре города можно пройти городской квест и открыть для себя город с неожиданной стороны."},
    {"name": "Старая Слобода",
    ...
    {"name": "Алёховщина",
     "desc": "Сердце оятской керамики. Здесь из красной глины рождаются не просто горшки, а хранители тепла человеческих рук. В Центре ремёсел проходят мастер-классы по лепке традиционной оятской игрушки."},
    {"name": "Тервеничи",
     "desc": "Покрово-Тервенический монастырь. Место, где северная строгость встречается с тихой благодатью."},
    {"name": "Доможирово", "desc": "Вход в Нижне-Свирский заповедник. Царство болот и глухарей."},
    {"name": "Оять",
    ...
    {"name": "Андреевщина",
     "desc": "Центр карельской культуры «Кондуши». Знакомство с традициями коренных народов, а также мастер-классы по росписи по дереву."},
    {"name": "Шоткуса",
...
with tab_excursions:
    ...
    with col2:
        caps_opts = ["Все", "Индивидуальная", "Семейная", "Групповая", "Школьная"]
        sel_cap = st.selectbox("Формат", caps_opts)
    with col3:
        # Новый фильтр по транспорту
        trans_opts = ["Все", "Пешая", "Автобусная", "На личном автотраспорте", "Комбинированная"]
